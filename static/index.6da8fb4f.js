...
`),u=r.map(function(d){return function(p,m,v){v===void 0&&(v=!1);var g="";g+=v?bl(p):Un(p);var x=p.shapeInfo.logicalShape,b=m.logicalShape;return x.length<=b.length&&(g+=v?function(y,w){var C,S=y.name,k=S.charAt(0).toUpperCase()+S.slice(1),I="get"+k+"AtOutCoords",R=y.shapeInfo.logicalShape.length,F=w.logicalShape.length,T=qt(y.shapeInfo.logicalShape,w.logicalShape),L=_e(F),O=F-R,B=["x","y","z","w","u","v"];C=R===0?"":F<2&&T.length>=1?"coords = 0;":T.map(function(ee){return"coords."+B[ee+O]+" = 0;"}).join(`
...
`)}function Un(r){var t=r.shapeInfo.logicalShape;switch(t.length){case 0:return function(e){var n=e.name,o="get"+n.charAt(0).toUpperCase()+n.slice(1);if(e.shapeInfo.isUniform)return"float "+o+"() {return "+n+";}";var a=e.shapeInfo.texShape,i=a[0],s=a[1];if(i===1&&s===1)return`
  ...
  `}var c=sn(n),l=c.newShape,h=c.keptDims,f=l;if(f.length<n.length){var d=Vn(e,f);return`
      `+Un(d)+`
      float `+a+`(int row, int col) {
        return `+a+"("+Gn(["row","col"],h)+`);
      }
...
`}(r);case 3:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[1]*n[2],s=n[2],u=sn(n),c=u.newShape,l=u.keptDims,h=c;if(h.length<n.length){var f=Vn(e,h);return`
        `+Un(f)+`
        float `+a+`(int row, int col, int depth) {
          return `+a+"("+Gn(["row","col","depth"],l)+`);
        }
      `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth) {
  ...
  `}(r);case 4:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[3],s=n[2]*i,u=n[1]*s,c=sn(n),l=c.newShape,h=c.keptDims;if(l.length<n.length){var f=Vn(e,l);return`
      `+Un(f)+`
      float `+a+`(int row, int col, int depth, int depth2) {
        return `+a+"("+Gn(["row","col","depth","depth2"],h)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth, int depth2) {
  ...
  `}(r);case 5:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[4],s=n[3]*i,u=n[2]*s,c=n[1]*u,l=sn(n),h=l.newShape,f=l.keptDims;if(h.length<n.length){var d=Vn(e,h);return`
      `+Un(d)+`
      float `+a+`(int row, int col, int depth, int depth2, int depth3) {
        return `+a+"("+Gn(["row","col","depth","depth2","depth3"],f)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth, int depth2, int depth3) {
        float index = dot(
  ...
  `}(r);case 6:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=sn(n),s=i.newShape,u=i.keptDims;if(s.length<n.length){var c=Vn(e,s);return`
      `+Un(c)+`
      float `+a+`(int row, int col, int depth,
                    int depth2, int depth3, int depth4) {
        return `+a+"("+Gn(["row","col","depth","depth2","depth3","depth4"],u)+`);
      }
  ...
  `}(r);case 3:return function(o){var a=o.shapeInfo.logicalShape,i=o.name,s="get"+i.charAt(0).toUpperCase()+i.slice(1),u=o.shapeInfo.texShape,c=[Math.ceil(u[0]/2),Math.ceil(u[1]/2)];if(a[0]===1){var l=a.slice(1),h=Vn(o,l);return`
        `+bl(h)+`
        vec4 `+s+`(int b, int row, int col) {
          return `+s+"("+Gn(["b","row","col"],[1,2])+`);
        }
